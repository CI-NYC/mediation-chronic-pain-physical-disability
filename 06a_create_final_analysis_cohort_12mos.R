...
mediators <- readRDS(file.path(drv_root, "mediator_12mo_df_updated.rds"))                                     # Mediator vars
...
# Save
saveRDS(mediation_analysis_df, file.path(drv_root, "mediation_12mo_analysis_df_updated.rds"))
