# -------------------------------------
# Script: 01_00_all_mediators.R
# Author: Nick Williams
# Purpose: Estimate indirect effects for each exposure dummy, analyzing all mediators together
# Notes: Run using `callr` package with 01_01_all_mediators.R
# -------------------------------------
...
saveRDS(result, file.path(drv_root, glue("result_{a}.rds")))
