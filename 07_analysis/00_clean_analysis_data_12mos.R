...
mediation_analysis_df <- readRDS(file.path(drv_root, "mediation_12mo_analysis_df_updated.rds"))
...
vars_to_keep <- c(
    ...
    "mediator_12mo_high_dose_longer_duration_mme",
    ...
    "mediator_12mo_nonopioid_nonoverlap_benzo",
    "mediator_12mo_nonopioid_nonoverlap_gaba",
    "mediator_12mo_nonopioid_nonoverlap_mrelax",
    "mediator_12mo_nonopioid_nonoverlap_antiinflamatory",
    "mediator_12mo_nonopioid_nonoverlap_antidepressant",
...
saveRDS(clean, file.path(drv_root, "mediation_12mo_analysis_df_clean_updated.rds"))
...
saveRDS(disability_pain_ref, file.path(drv_root, "subset_12mo_disability_pain_ref_df_updated.rds"))
...
saveRDS(disability_only_ref, file.path(drv_root, "subset_12mo_disability_only_ref_df_updated.rds"))
...
saveRDS(pain_only_ref, file.path(drv_root, "subset_12mo_pain_only_ref_df_updated.rds"))
