...
Z <- c("mediator_12mo_high_dose_longer_duration_mme", #MME
...
if (Y == "oud_24mo_icd")
{
    if(mh == TRUE)
    {
        saveRDS(result, paste0("/mnt/general-data/disability/mediation_unsafe_pain_mgmt/mediation_results_final_r1/washout_12mo/depanx_icd/", mediator, "_icd_results_", exposure, "_depanx_seed", seed, ".rds"))
    }else
    {
        saveRDS(result, paste0("/mnt/general-data/disability/mediation_unsafe_pain_mgmt/mediation_results_final_r1/washout_12mo/nodepanx_icd/", mediator, "_icd_results_", exposure, "_nodepanx_seed", seed, ".rds"))
    }
