...
## -----------------------------------------------------------------------------------------------------------
directory <- "/mnt/general-data/disability/mediation_unsafe_pain_mgmt/mediation_results_final_r1/conditional_Z_final/depanx"
...
results_depanx$exposure <- str_extract(res, "(?<=results_exposure_).*?(?=.rds)")
results_depanx$type <- "depanx"

directory <- "/mnt/general-data/disability/mediation_unsafe_pain_mgmt/mediation_results_final_r1/conditional_Z_final/nodepanx"
...
results_nodepanx$exposure <- str_extract(res, "(?<=results_exposure_).*?(?=.rds)")
...
ggsave("~/mediation-chronic-pain-physical-disability/10_figures/final_figs/group_mediators_icd_conditional_Z_final.pdf", group_plot, dpi = 300, height = 8, width = 9)
