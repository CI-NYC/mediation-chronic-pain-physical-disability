...
#   the analysis cohort had a claim for electrical nerve stimulation
...
mediator <- "Electrical nerve stimulation"
...
claims <- claims[, .(mediator_has_electrical_nerve_stimulation = as.numeric(.N > 0)), by = "BENE_ID"]
...
claims[, mediator_has_electrical_nerve_stimulation := fifelse(is.na(mediator_has_electrical_nerve_stimulation), 0, mediator_has_electrical_nerve_stimulation)]

saveRDS(claims, file.path(drv_root, "mediator_has_electrical_nerve_stimulation.rds"))
