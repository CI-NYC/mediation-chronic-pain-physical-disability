...
max_daily_dose[, mediator_12mo_max_daily_dose_mme := fifelse(is.na(mediator_12mo_max_daily_dose_mme), 0, mediator_12mo_max_daily_dose_mme)]

# Save final dataset -----------------------------------------------------------

saveRDS(max_daily_dose, file.path(data_dir, "mediator_12mo_max_daily_dose_mme_022425.rds"))
