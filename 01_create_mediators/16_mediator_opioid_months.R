...
rx[, `:=`(month1 = RX_DT %within% interval(washout_cal_end_dt, washout_cal_end_dt + days(30)), 
          month2 = RX_DT %within% interval(washout_cal_end_dt + days(31), washout_cal_end_dt + days(61)), 
          month3 = RX_DT %within% interval(washout_cal_end_dt + days(62), washout_cal_end_dt + days(92)), 
          month4 = RX_DT %within% interval(washout_cal_end_dt + days(93), washout_cal_end_dt + days(122)), 
          month5 = RX_DT %within% interval(washout_cal_end_dt + days(123), washout_cal_end_dt + days(152)), 
          month6 = RX_DT %within% interval(washout_cal_end_dt + days(153), washout_cal_end_dt + days(182)))]
...
saveRDS(opioid_months, file.path(drv_root, "mediator_months_opioid_prescription.rds"))
