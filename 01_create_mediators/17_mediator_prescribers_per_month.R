...
prescribers[, c("month1", "month2", "month3", "month4", "month5", "month6") := 
                .(RX_FILL_DT %within% interval(washout_cal_end_dt, washout_cal_end_dt + days(30)),
                  RX_FILL_DT %within% interval(washout_cal_end_dt + days(31), washout_cal_end_dt + days(61)),
                  RX_FILL_DT %within% interval(washout_cal_end_dt + days(62), washout_cal_end_dt + days(92)),
                  RX_FILL_DT %within% interval(washout_cal_end_dt + days(93), washout_cal_end_dt + days(122)),
                  RX_FILL_DT %within% interval(washout_cal_end_dt + days(123), washout_cal_end_dt + days(152)),
                  RX_FILL_DT %within% interval(washout_cal_end_dt + days(153), washout_cal_end_dt + days(182)))]
...
saveRDS(mediator_prescribers_per_month, file.path(drv_root, "mediator_prescribers_per_month.rds"))
