...
# Read the opioid and nonopioid pain prescription datasets
  # RXL datasets
opioid_pain_rx_rxl <- readRDS(file.path(drv_root, "mediator_rxl_opioid_pain_rx.rds"))
nonopioid_pain_rx_rxl <- readRDS(file.path(drv_root, "mediator_rxl_nonopioid_pain_rx.rds"))
  # OTL datasets
opioid_pain_rx_otl <- readRDS(file.path(drv_root, "mediator_otl_opioid_pain_rx.rds"))
...
saveRDS(nonoverlap_nonopioid_pain_rx_rxl, file.path(drv_root, "mediator_rxl_nonoverlap_nonopioid_pain_rx.rds"))
saveRDS(nonoverlap_nonopioid_pain_rx_otl, file.path(drv_root, "mediator_otl_nonoverlap_nonopioid_pain_rx.rds"))
