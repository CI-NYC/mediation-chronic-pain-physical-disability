...
#   the analysis cohort had a claim for intrathecal drug therapies
...
claims <- claims[, .(mediator_has_intrathecal_drug_therapy = as.numeric(.N > 0)), by = "BENE_ID"]
...
claims[, mediator_has_intrathecal_drug_therapy := fifelse(is.na(mediator_has_intrathecal_drug_therapy), 0, mediator_has_intrathecal_drug_therapy)]

saveRDS(claims, file.path(drv_root, "mediator_has_intrathecal_drug_therapy.rds"))
